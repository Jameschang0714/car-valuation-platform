...
TRANSLATIONS = {
    'en': {
        ...
        'app_subtitle': 'Mabuhay! Input car details to search across major Philippine platforms. (v2.9 - Friendly Edition)',
    ...
    'zh': {
        ...
        'app_subtitle': '輸入車輛資訊，自動搜尋菲律賓各大拍賣平台行情。(版本: 2.8 - 雙語版)',
        'search_params': '搜尋條件',
        'make': '品牌 (Make)',
        'model': '車型 (Model)',
        'year': '年份 (Year)',
