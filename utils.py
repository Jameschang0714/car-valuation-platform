...
TRANSLATIONS = {
    'en': {
        ...
        'app_subtitle': 'Mabuhay! Input car details to search across major Philippine platforms. (v3.3.3 - Stable)',
    ...
    'zh': {
        ...
        'app_subtitle': '輸入車輛資訊，自動搜尋菲律賓各大拍賣平台行情。(版本: 3.3.3 - Philkotse 修正版)',
        'search_params': '搜尋條件',
        'make': '品牌 (Make)',
        'model': '車型 (Model)',
        'year': '年份 (Year)',
